...
!function (e, t) {
	...
	function m(e, t) {
		...
		if ('string' == typeof e) {
			...
			if (n.indexOf('<') >= 0 && n.indexOf('>') >= 0) {
				...
				for (var i = [
				], s = t.querySelectorAll(e), a = 0; a < s.length; a += 1) i.push(s[a]);
				return i
			}(e.trim(), t || s)
	...
	var g,
		...
		y = {
			...
			parent: function (e) {
				for (var t = [
				], i = 0; i < this.length; i += 1) null !== this[i].parentNode && (e ? m(this[i].parentNode).is(e) && t.push(this[i].parentNode) : t.push(this[i].parentNode));
				return m(t)
			},
			parents: function (e) {
				for (var t = [
				], i = 0; i < this.length; i += 1) for (var s = this[i].parentNode; s;) e ? m(s).is(e) && t.push(s) : t.push(s),
					s = s.parentNode;
				return m(t)
			},
			closest: function (e) {
			...
			children: function (e) {
				for (var t = [
				], i = 0; i < this.length; i += 1) for (var s = this[i].children, a = 0; a < s.length; a += 1) e && !m(s[a]).is(e) || t.push(s[a]);
				return m(t)
			},
			filter: function (e) {
				return m(f(this, e))
	...
	function T(e, t) {
		...
		return r.WebKitCSSMatrix ? ((s = n.transform || n.webkitTransform).split(',').length > 6 && (s = s.split(', ').map((function (e) {
			return e.replace(',', '.')
		})).join(', ')), a = new r.WebKitCSSMatrix('none' === s ? '' : s)) : i = (a = n.MozTransform || n.OTransform || n.MsTransform || n.msTransform || n.transform || n.getPropertyValue('transform').replace('translate(', 'matrix(1, 0, 0, 1,')).toString().split(','),
	...
	function O(e) {
		...
		if (!this.animating || !a.preventInteractionOnTransition) {
			...
			var d = m(o.target);
			if (('wrapper' !== a.touchEventsTarget || d.closest(this.wrapperEl).length) && (s.isTouchEvent = 'touchstart' === o.type, (s.isTouchEvent || !('which' in o) || 3 !== o.which) && !(!s.isTouchEvent && 'button' in o && o.button > 0 || s.isTouched && s.isMoved))) if (a.noSwiping && d.closest(a.noSwipingSelector ? a.noSwipingSelector : '.' + a.noSwipingClass)[0]) this.allowClick = !0;
	...
	function A(e) {
		...
		if (l.originalEvent && (l = l.originalEvent), i.isTouched) {
			if (!i.isTouchEvent || 'touchmove' === l.type) {
				...
				if (l.preventedByNestedSwiper) return a.startX = d,
					void (a.startY = h);
				...
				if (i.isTouchEvent && t.activeElement && l.target === t.activeElement && m(l.target).is(i.formElements)) return i.isMoved = !0,
	...
	function D(e) {
		...
		if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, h = s.followFinger ? r ? t.translate : - t.translate : - i.currentTranslate, !s.cssMode) if (s.freeMode) {
			...
			if (s.freeModeMomentum) {
				...
				var g = 1000 * s.freeModeMomentumRatio,
					w = t.velocity * g,
					b = t.translate + w;
				r && (b = - b);
				var y,
				...
				if (b < t.maxTranslate()) s.freeModeMomentumBounce ? (b + t.maxTranslate() < - S && (b = t.maxTranslate() - S), y = t.maxTranslate(), C = !0, i.allowMomentumBounce = !0) : b = t.maxTranslate(),
					s.loop && s.centeredSlides && (T = !0);
				else if (b > t.minTranslate()) s.freeModeMomentumBounce ? (b - t.minTranslate() > S && (b = t.minTranslate() + S), y = t.minTranslate(), C = !0, i.allowMomentumBounce = !0) : b = t.minTranslate(),
					s.loop && s.centeredSlides && (T = !0);
		...
		V = {
			...
			eventsEmitter: {
				...
				off: function (e, t) {
					...
					return i.eventsListeners ? (e.split(' ').forEach((function (e) {
						...
						] : i.eventsListeners[e] && i.eventsListeners[e].forEach((function (s, a) {
					...
					if (void 0 !== s) {
						...
						for (var M, z = t.slidesPerColumn, P = T / z, k = Math.floor(h / t.slidesPerColumn), $ = 0; $ < h; $ += 1) {
							...
							if ('none' !== L.css('display')) {
								...
								} else C = (s - (t.slidesPerView - 1) * b) / t.slidesPerView,
									t.roundLengths && (C = Math.floor(C)),
									d[$] && (this.isHorizontal() ? d[$].style.width = C + 'px' : d[$].style.height = C + 'px');
								d[$] && (d[$].swiperSlideSize = C),
									c.push(C),
									t.centeredSlides ? (y = y + C / 2 + E / 2 + b, 0 === E && 0 !== $ && (y = y - s / 2 - b), 0 === $ && (y = y - s / 2 - b), Math.abs(y) < 0.001 && (y = 0), t.roundLengths && (y = Math.floor(y)), x % t.slidesPerGroup == 0 && p.push(y), u.push(y)) : (t.roundLengths && (y = Math.floor(y)), (x - Math.min(this.params.slidesPerGroupSkip, x)) % this.params.slidesPerGroup == 0 && p.push(y), u.push(y), y = y + C + b),
			...
			translate: {
				...
				translateTo: function (e, t, i, s, a) {
					...
					if (o = s && e > d ? d : s && e < h ? h : e, r.updateProgress(o), n.cssMode) {
						...
						else if (l.scrollTo) l.scrollTo(((p = {
						})[u ? 'left' : 'top'] = - o, p.behavior = 'smooth', p));
			...
			slide: {
				slideTo: function (e, t, i, s) {
					...
					if (f = r > h ? 'next' : r < h ? 'prev' : 'reset', p && - m === a.translate || !p && m === a.translate) return a.updateActiveIndex(r),
					...
					if (n.cssMode) {
						...
						else if (u.scrollTo) u.scrollTo(((w = {
						})[b ? 'left' : 'top'] = y, w.behavior = 'smooth', w));
			...
			events: {
				attachEvents: function () {
					...
					var o = !!t.nested;
					if (!l.touch && l.pointerEvents) s.addEventListener(i.start, this.onTouchStart, !1),
			...
			return r.emitContainerClasses = function () {
				...
				r.changeDirection = function (e, t) {
					...
					return e || (e = 'horizontal' === i ? 'vertical' : 'horizontal'),
						e === i || 'horizontal' !== e && 'vertical' !== e || (this.$el.removeClass('' + this.params.containerModifierClass + i).addClass('' + this.params.containerModifierClass + e), this.emitContainerClasses(), this.params.direction = e, this.slides.each((function (t) {
				...
				r.destroy = function (e, t) {
					...
					var i,
						...
						n = s.$wrapperEl,
						l = s.slides;
					return void 0 === s.params || s.destroyed || (s.emit('beforeDestroy'), s.initialized = !1, s.detachEvents(), a.loop && s.loopDestroy(), t && (s.removeClasses(), r.removeAttr('style'), n.removeAttr('style'), l && l.length && l.removeClass([a.slideVisibleClass,
					a.slideActiveClass,
					a.slideNextClass,
					a.slidePrevClass].join(' ')).removeAttr('style').removeAttr('data-swiper-slide-index')), s.emit('destroy'), Object.keys(s.eventsListeners).forEach((function (e) {
						s.off(e)
	...
	var R = {
		update: function (e) {
			...
			}), h === y && p === E && !e) return t.slidesGrid !== c && x !== f && t.slides.css(m, x + 'px'),
	...
	var U = {
		...
		ae = {
			init: function () {
				...
				if (this.params.history) {
					if (!e.history || !e.history.pushState) return this.params.history.enabled = !1,
		...
		re = {
			...
			setHash: function () {
				var e = l(),
					t = r();
				if (this.hashNavigation.initialized && this.params.hashNavigation.enabled) if (this.params.hashNavigation.replaceState && e.history && e.history.replaceState) e.history.replaceState(null, null, '#' + this.slides.eq(this.activeIndex).attr('data-hash') || ''),
					this.emit('hashSet');
				else {
